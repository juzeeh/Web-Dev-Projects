...
<head>
  ...
  <title> Zaybann Restaurant </title>
    ...
    <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar" >
      ...
      <li class="nav-item mt-5">
        <a class="nav-link" href="dashboard.php">
          ...
          <span class="mmfont"> Dashboard </span></a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link" href="order_list.php">
          ...
          <span class="mmfont">  Order </span></a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link" href="customer_list.php">
          ...
          <span class="mmfont"> Customer </span></a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link" href="category_list.php">
          ...
          <span class="mmfont"> Category  </span></a>
      </li>
